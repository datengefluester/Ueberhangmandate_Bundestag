...
# installs needed in ubuntu 18.04 for the projections
...
```{r Historic_Parliament_Size_graph}
...
```{r dynamic_size_graph_pic,echo=FALSE, eval=FALSE}
ggsave("./HP_pic/dynamic_size_graph_pic.jpg",width=4, height=3)
```
