...
```
```{r graph_vote_distribution_pic,echo=FALSE, eval=FALSE}
ggsave("./HP_pic/graph_vote_distribution.jpg", width=4, height=3)
```
...
```{r dashboard_csv,warning=FALSE, message=FALSE, eval=FALSE}
...
### Margin by Party
```{r margin_party_graph, warning=FALSE}
ueberhangmandate %>%
...
```{r margin_party_graph_pic,echo=FALSE, eval=FALSE}
ggsave("./HP_pic/margin_party_graph_pic.jpg",width=4, height=3)
```
...
anim_save("./HP_pic/dynamic_map.gif", width = 1000, height = 1000)
```



### Finalising the data set for Shiny Dashboard
```{r dashboard, message=FALSE, echo=FALSE, eval=FALSE}
