...
ggsave("./pictures/map_actual_election.jpg", width=4, height=3)
```
...
ggsave("./pictures/graph_vote_distribution.jpg", width=4, height=3)
```
...
ggsave("./pictures/optimized_election_map_pic.jpg",width=4, height=3)
```
...
ggsave("./pictures/margins_graph.jpg",width=4, height=3)
```
...
anim_save("./pictures/dynamic_map.gif", width = 1000, height = 1000)
```
